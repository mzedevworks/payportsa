...
class ReoccurCollectionController extends Controller
{
    ...
    public function ajaxProcessedList(Request $request){
        ...
        $bindings=[$batchId,$firmId,2];

        $whereConditions ="collections.batch_id =? and collections.firm_id=? and collections.collection_status !=?";
        $totalCount = DB::table('collections')
    ...
    function failedTransactions(Request $request){
        ...
        return view('merchant.reoccur-collection.failedTransactions',compact('pagename','request','urlStrg','urlParams'));
    }
    ...
    function disputedTransactions(Request $request){
      ...
      return view('merchant.reoccur-collection.disputedTransactions',compact('pagename','request','urlStrg','urlParams'));
    }
    ...
    function reports(Request $request){
        ...
        if(sizeof($request->query())>0){
            return view('merchant.reoccur-collection.generate-reports',compact('pagename','request','urlParams'));
        }else{
            return view('merchant.reoccur-collection.reports',compact('pagename','request','urlParams'));
        }
