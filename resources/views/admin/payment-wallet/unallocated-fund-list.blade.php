...
function generateAction(data, type, row, meta){
    ...
    var str='<div class="float-left"><a href="{{url('admin/payment-wallet/allocate/')}}/'+data+'" class="btn bg-transparent"  data-toggle="tooltip" data-placement="top" data-original-title="Allocate"><i class="lni-pencil" aria-hidden="true"></i></a></div>';
...
$(document).ready(function() {
    ...
    myFirmTable=$('#firms-datatable').DataTable({
        ...
        searching: true,
        ajax: {
            url: "{{ url('admin/payment-wallet/ajax-non-allocated')}}"
        },
        //dom: "rtiS",
        "columns": [
            {"data":0},
