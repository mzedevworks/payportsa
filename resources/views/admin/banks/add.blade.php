      ...
      <div class="col-12 grid-margin">
        <div class="card">
          ...
          <div class="card-body">
            ...
            action="{{ url('admin/banks/create') }}" autocomplete="off">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('avs_bank_code')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="avs_bank_code" value="{{ old('avs_bank_code') }}" id="avs_bank_code" placeholder="AVS Bank Code">
                    ...
                    <label class="col-sm-3">Is Active *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_active_true" name="is_active" value="yes" {{ (old('is_active')=='yes') ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_active_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_active_false" name="is_active" value="no" {{ (old('is_active')=='no') ? 'checked': ''}}>
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-3">Savings *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_savings_true" name="is_savings" value="yes" {{ (old('is_savings')=='yes') ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_savings_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_savings_false" name="is_savings" value="no" {{ (old('is_savings')=='no') ? 'checked': ''}}>
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-3">Cheque *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_cheque_true" name="is_cheque" value="yes" {{ (old('is_cheque')=='yes') ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_cheque_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_cheque_false" name="is_cheque" value="no" {{ (old('is_cheque')=='no') ? 'checked': ''}}>
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-3">Real Time *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_realtime_avs_true" name="is_realtime_avs" value="yes" {{ (old('is_realtime_avs')=='yes') ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_realtime_avs_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_realtime_avs_false" name="is_realtime_avs" value="no" {{ (old('is_realtime_avs')=='no') ? 'checked': ''}}>
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-3">Batch AVS *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_batch_avs_true" name="is_batch_avs" value="yes" {{ (old('is_batch_avs')=='yes') ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_batch_avs_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          <input type="radio" class="custom-control-input" id="is_batch_avs_false" name="is_batch_avs" value="no" {{ (old('is_batch_avs')=='no') ? 'checked': ''}}>
