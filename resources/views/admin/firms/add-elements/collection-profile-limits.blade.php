<div class="row">
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('line_collection')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Line Limit" name="line_collection" value="{{ old('line_collection') }}">
  ...
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('monthly_collection')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Monthly Limit" name="monthly_collection" value="{{ old('monthly_collection') }}">
  ...
  <div class="col-md-6">
      <div class="form-group row {{ $errors->first('surety_amount')?'has-error':'' }}">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="Surety Percentage" name="surety_amount" value="{{ old('surety_amount') }}">
  ...
  <!-- <div class="col-md-6">
    <div class="form-group row {{ $errors->first('batch_collection')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Batch Limit" name="batch_collection" value="{{ old('batch_collection') }}">
  ...
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('daily_collection')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Daily Limit" name="daily_collection" value="{{ old('daily_collection') }}">
