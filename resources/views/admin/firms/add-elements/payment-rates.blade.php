<div class="row">
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('same_day_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Same Day" name="same_day_payment" value="{{ old('same_day_payment') }}">
  ...
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('one_day_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="One day payment" name="one_day_payment" value="{{ old('one_day_payment') }}">
 ...
 <div class="col-md-6">
    <div class="form-group row {{ $errors->first('two_day_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Two day payment" name="two_day_payment" value="{{ old('two_day_payment') }}">
 ...
 <div class="col-md-6">
    <div class="form-group row {{ $errors->first('batch_fee_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Batch Fee" name="batch_fee_payment" value="{{ old('batch_fee_payment') }}">
 ...
 <div class="col-md-6">
    <div class="form-group row {{ $errors->first('failed_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Failed Transaction" name="failed_payment" value="{{ old('failed_payment') }}">
