    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-sample" method="post" action="{{ url('admin/firms/create') }}" autocomplete="off">
              @csrf
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('mandate_ref')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Mandate Ref" name="mandate_ref" value="{{old('mandate_ref')}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('trading_as')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Abbreviated Name" name="trading_as" value="{{old('trading_as')}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('business_name')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Business Name" name="business_name" value="{{old('business_name')}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('vat_no')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="vat_no" class="form-control" placeholder="VAT No." value="{{ old('vat_no') }}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('registration_no')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="registration_no" class="form-control" placeholder="Registration No." value="{{old('registration_no') }}">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="entry_class">
                        ...
                        @foreach(Config('constants.entry_class') as $key =>$entry_class)
                          <option value="{{$key}}" {{ old('entry_class')==$key ? 'selected' : ''}}>{{$entry_class}}</option>
                        @endforeach
                      </select>
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('setup_collection_date')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control collection_date" placeholder="SetUp Collection Date" name="setup_collection_date" value="{{ old('setup_collection_date') }}" id="setup_collection_date">
                ...
                <div class="col-md-6">
                    <div class="form-group row {{ $errors->first('monthly_fee')?'has-error':'' }}">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="Monthly Fee" name="monthly_fee" value="{{ old('monthly_fee') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group row {{ $errors->first('monthly_collection_date')?'has-error':'' }}">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="Monthly Collection Date" name="monthly_collection_date" value="{{old('monthly_collection_date')}}" id="monthly_collection_date">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('address1')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" placeholder="Address" name="address1">{{ old('address1') }}</textarea>
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('address2')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" placeholder="Address" name="address2">{{ old('address2') }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('subrub')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="subrub" class="form-control" placeholder="Suburb" value="{{ old('subrub') }}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('po_box_number')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="PO Box" name="po_box_number" value="{{old('po_box_number')}}">
              ...
              <div class="row">
                  ...
                  <div class="form-group row {{ $errors->first('bank_id')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="bank_id" id="bank_id">
                        ...
                        {{ old('bank_id')==$bankDetail->id ? 'selected' : '' }} 
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('branch_code')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="branch_code" value="{{ old('branch_code') }}" id="branch_code" placeholder="Branch Code">
              ...
              <div class="row">
                    ...
                    <label class="col-sm-3">Payments *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          ...
                          <input type="radio" class="custom-control-input" id="is_payment_true" name="is_payment" value="1" {{ (intval(old('is_payment'))===1) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                          <label class="custom-control-label" for="is_payment_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          
                          <input type="radio" class="custom-control-input" id="is_payment_false" name="is_payment" value="0" {{ (intval(old('is_payment'))===0 && sizeof($errors)>0 && !$errors->first('is_payment')) ? 'checked': ''}}  onclick="verifySubproductVisiblity()">
                ...
                <div class="col-md-12  {{ (old('is_payment')==1) ? '': 'd-none'}} " id="paymentProducts">
                  <div class="form-group row">
                    <label class="col-sm-3">Sub-product of Payments *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-checkbox checkbox custom-control-inline">
                          ...
                          <input type="checkbox" class="custom-control-input" name="is_salaries" id="is_salaries" value="1" {{ (old('is_salaries')==1) ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_salaries">Salaries</label>
                        </div>
                      
                        <div class="custom-control custom-checkbox checkbox custom-control-inline">
                          
                          <input type="checkbox" class="custom-control-input" name="is_creditors" id="is_creditors" value="1" {{ (old('is_creditors')==1) ? 'checked': ''}}>
                    ...
                    <label class="col-sm-3">Collections *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          ...
                          <input type="radio" class="custom-control-input" id="is_collection_true" name="is_collection" value="1" {{ (intval(old('is_collection'))===1) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                          <label class="custom-control-label" for="is_collection_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          
                          <input type="radio" class="custom-control-input" id="is_collection_false" name="is_collection" value="0" {{ (intval(old('is_collection'))===0 && sizeof($errors)>0 && !$errors->first('is_collection')) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                ...
                <div class="col-md-12  {{ (old('is_collection')==1) ? '': 'd-none'}}"  id="collectionProducts">
                  <div class="form-group row">
                    <label class="col-sm-3">Sub-product of Collection *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-checkbox checkbox custom-control-inline">
                          ...
                          <input type="checkbox" class="custom-control-input" name="is_normal_collection" id="is_normal_collection" value="1" {{ (old('is_normal_collection')==1) ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_normal_collection">Normal Collection</label>
                        </div>
                      
                        <div class="custom-control custom-checkbox checkbox custom-control-inline">
                          
                          <input type="checkbox" class="custom-control-input" name="is_reoccur_collection" id="is_reoccur_collection" value="1" {{ (old('is_reoccur_collection')==1) ? 'checked': ''}}>
                    ...
                    <label class="col-sm-3">DebiCheck *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          ...
                          <input type="radio" class="custom-control-input" id="is_debicheck_true" name="is_debicheck" value="1" {{ (intval(old('is_debicheck'))===1) ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_debicheck_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          
                          <input type="radio" class="custom-control-input" id="is_debicheck_false" name="is_debicheck" value="0" {{ (intval(old('is_debicheck'))===0 && sizeof($errors)>0 && !$errors->first('is_debicheck')) ? 'checked': ''}}>
                    ...
                    <label class="col-sm-3">AVS *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          ...
                          <input type="radio" class="custom-control-input" id="is_avs_true" name="is_avs" value="1" {{ (intval(old('is_avs'))===1) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                          <label class="custom-control-label" for="is_avs_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">

                          <input type="radio" class="custom-control-input" id="is_avs_false" name="is_avs" value="0" {{ (intval(old('is_avs'))===0 && sizeof($errors)>0 && !$errors->first('is_avs')) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                ...
                <div class="col-md-12  {{ (old('is_avs')==1) ? '': 'd-none'}}" id="avsProducts">
                    <div class="form-group row">
                        <label class="col-sm-3">Sub-product of AVS *</label>
                        <div class="col-sm-9">
                            <div class="custom-control custom-checkbox checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" name="is_avs_batch" id="is_avs_batch" value="1"
                                    {{ (old('is_avs_batch')==1) ? 'checked': ''}}>
                                <label class="custom-control-label" for="is_avs_batch">AVS Batch</label>
                            </div>
                            <div class="custom-control custom-checkbox checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" name="is_avs_rt" id="is_avs_rt" value="1"
                                    {{ (old('is_avs_rt')==1) ? 'checked': ''}}>
                                <label class="custom-control-label" for="is_avs_rt">AVS Real Time</label>
                            </div>
                            <p class="error">{{$errors->first('is_normal_collection')}}</p>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  var is_salaries = '{{ old('is_salaries')==1 ? "checked"  : '' }}';
  var is_creditors = '{{ old('is_creditors')==1 ? "checked"  : '' }}';
