              ...
              <div class="row">
                <div class="col-12 grid-margin">
                  <div class="card">
                    ...
                    onclick="verifySubproductVisiblity()">
                    ...
                    onclick="verifySubproductVisiblity()">
                          ...
                          <div class="col-md-12  {{ (old('is_avs',$firm['is_avs'])==1) ? '': 'd-none'}}" id="avsProducts">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-checkbox checkbox custom-control-inline">
                                            ...
                                            <input type="checkbox" class="custom-control-input" name="is_avs_batch" id="is_avs_batch" value="1" {{ (old('is_avs_batch',$firm['is_avs_batch'])==1) ? 'checked': ''}}>
                                            <label class="custom-control-label" for="is_avs_batch">AVS Batch</label>
                                        </div>

                                        <div class="custom-control custom-checkbox checkbox custom-control-inline">

                                            <input type="checkbox" class="custom-control-input" name="is_avs_rt" id="is_avs_rt" value="1" {{ (old('is_avs_rt',$firm['is_avs_rt'])==1) ? 'checked': ''}}>
                                            <label class="custom-control-label" for="is_avs_rt">AVS Real Time</label>
                                        </div>
                                        <p class="error">{{$errors->first('is_avs_batch')}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
