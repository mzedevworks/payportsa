<div class="row">
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('same_day_collection')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Same Day" name="same_day_collection" value="{{old('same_day_collection',$rates['same_day_collection'])}}">
  ...
  <div class="col-md-6">
      <div class="form-group row {{ $errors->first('one_day_collection')?'has-error':'' }}">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="One day collection" name="one_day_collection" value="{{old('one_day_collection',$rates['one_day_collection'])}}">
    ...
    <div class="col-md-6">
      <div class="form-group row {{ $errors->first('two_day_collection')?'has-error':'' }}">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="Two day collection" name="two_day_collection" value="{{old('two_day_collection',$rates['two_day_collection'])}}">
    ...
    <!-- <div class="col-md-6">
        <div class="form-group row {{ $errors->first('batch_fee_collection')?'has-error':'' }}">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="Batch Fee" name="batch_fee_collection" value="{{old('batch_fee_collection',$rates['batch_fee_collection'])}}">
    ...
    <div class="col-md-6">
      <div class="form-group row {{ $errors->first('failed_collection')?'has-error':'' }}">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" placeholder="Failed Transaction" name="failed_collection" value="{{old('failed_collection',$rates['failed_collection'])}}">
