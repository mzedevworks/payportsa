...
@section('content')
 <div class="container-fluid">
    ...
    @if($firmDetails->is_collection===1 && $transactionLimit && ($transactionLimit->closing_balance-$transactedAmount->tot_amount)<=config('constants.profileAlertValue'))
      <div class="alert alert-danger" role="alert">
        <strong>Oh snap!</strong> Increase your profile limit only, You are having only ${{$transactionLimit->closing_balance-$transactedAmount->tot_amount}}
      </div>
    @endif
      ...
      <div class="follow">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Service Cut-Offs</h4>
            <div class="card-toolbar">
              <ul>
                <li>
                  <a class="text-gray" onclick="javascript:void(0)">
          ...
          <ul class="list-media">
            ...
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">Collection</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Config('constants.bankingCutOffTimeReadable')}}</button>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">Same Day payment</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Config('constants.sameDayPaymentCutOffTimeReadable')}}</button>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">One Day payment</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Config('constants.oneDayPaymentCutOffTimeReadable')}}</button>
                  </div>
                </div>
              </div>
            </li>
          ...
          <ul class="list-media">
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">1 Day Collection</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Helper::convertDate(Helper::getPaymentDate(['1 Day'],date('Y-m-d',strtotime("+ 1 day"))),'d-m-Y')}}</button>
                  </div>
                </div>
              </div>
            </li>
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">2 Day Collection</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Helper::convertDate(Helper::getPaymentDate(['2 Day'],date('Y-m-d',strtotime("+ 2 day"))),'d-m-Y')}}</button>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">Same Day Payment</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Helper::convertDate(Helper::getPaymentDate(['sameday'],date('Y-m-d',strtotime("+ 1 day"))),'d-m-Y')}}</button>
                  </div>
                </div>
              </div>
            </li>
            <li class="list-item">
              <div class="client-item">
                ...
                <div class="info">
                  <span class="title text-semibold">Dated Payment</span>
                  <div class="float-item">
                    <button class="btn btn-common btn-rounded">{{Helper::convertDate(Helper::getPaymentDate(['dated'],date('Y-m-d',strtotime("+ 1 day"))),'d-m-Y')}}</button>
                  </div>
                </div>
              </div>
            </li>
...
function updateGraphs(dayLimit,fromDate,toDate){
  $.ajax({
        type  : 'post',
        url   : "{{url('merchant/dashboard/collection-graph-data')}}",
...
function updatePaymentGraphs(dayLimit,fromDate,toDate){
  $.ajax({
        type  : 'post',
        url   : "{{url('merchant/dashboard/payment-graph-data')}}",
        data  : { dayLimit: dayLimit ,fromDate: fromDate,toDate:toDate},
        success : function(data){
            data=JSON.parse(data);
