    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    @if(!isset($selectedEmployees))
                       <form class="form-sample" method="post" 
                        action="{{ url('merchant/employees/batchimport') }}" enctype="multipart/form-data" autocomplete="off">
                          @csrf
                       ...
                       <a href="{{ url('merchant/employees/samplebatchcsv')}}" class="purple-btn">Download Sample csv</a>
                    @endif
                </div>
            </div>
        </div>
