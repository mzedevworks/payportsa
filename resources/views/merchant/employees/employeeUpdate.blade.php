        ...
        <div class="card">
          <div class="card-body">
            <form class="form-sample" method="post" autocomplete="off">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('first_name')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="First Name" name="first_name" value="{{old('first_name',$employee['first_name'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('last_name')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="{{old('last_name',$employee['last_name'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('email')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Email" name="email" value="{{ old('email',$employee['email'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('id_number')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Employee Id" name="id_number" value="{{old('id_number',$employee['id_number'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('salary')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Salary" name="salary" value="{{old('salary',$employee['salary'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('contact_number')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Contact No." name="contact_number" value="{{old('contact_number',$employee['contact_number'])}}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('reference')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Reference" name="reference" value="{{old('reference',$employee['reference'])}}">
              ...
              <div class="row">
                          ...
                          <div class="form-group row {{ $errors->first('bank_id')?'has-error':'' }}">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" name="bank_id" id="bank_id">
                                ...
                                {{ $eachBank->id==old('bank_id',$employee['bank_id'])?'selected':''}}
                        ...
                        <div class="col-md-6">
                          <div class="form-group row {{ $errors->first('branch_code')?'has-error':'' }}">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="branch_code" id="branch_code" value="{{old('branch_code',$employee['branch_code'])}}" readonly="">
                          ...
                          <div class="form-group row {{ $errors->first('account_type')?'has-error':'' }}">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" name="account_type">
                                ...
                                <option value="{{ $type }}" 
                                {{ $type===old('account_type',$employee['account_type'])?'selected':''}}
                                >{{ $type }}</option>
                                @endforeach
                              </select>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row {{ $errors->first('account_holder_name')?'has-error':'' }}">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="account_holder_name" value="{{old('account_holder_name',$employee['account_holder_name'])}}">
              ...
              <a href="{{ url('merchant/employees') }}" class="btn btn-light">Cancel</a>
            </form>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  var bank_id = '{{ old("bank_id",$employee["bank_id"])}}';
  if(bank_id!=''){
