                ...
                <div class="card-header border-bottom">
                    @if(count($employees)==0)
                       <form class="form-sample" method="post" 
                        action="{{ url('merchant/employees/import') }}" enctype="multipart/form-data" autocomplete="off">
                          @csrf
                         <input type="file" name="file_name">
                         <input type="submit" name="" class="btn btn-common" value="Upload List"></a>
                       </form>
                       <a href="{{ url('merchant/employees/samplecsv')}}" class="purple-btn">Download Sample csv</a>
                    @endif
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-warning" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          ...
                          <strong>Warning!</strong> Please update the pending employees With proper formate then only you will be able to upload next file .
                          <a class="btn btn-common pull-right purple-btn mr-4" href="{{ url('merchant/employees/delete/tempcsv')}}" class="purple-btn">Discard All</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="float-left">
                                                ...
                                                <form method="POST" action="{{ url('merchant/temp/employees/delete/'.encrypt($employee->id))}}" class="btn bg-transparent">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
