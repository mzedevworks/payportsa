        ...
        <div class="col-12">
            <div class="card">
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a href="{{url('merchant/collection/reoccur/customer/view/').'/'.Helper::encryptVar($customerId)}}" class="nav-link " >Customer Info</a>
                </li>
                <li class="nav-item">
                  <a href="{{url('merchant/collection/reoccur/customer/transactions/').'/'.Helper::encryptVar($customerId)}}" class="nav-link active">History</a>
                </li>
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
        ...
        searching: true,
        ajax: {
            url: "{{ url('merchant/collection/reoccur/customer/ajax-transactions/'.Helper::encryptVar($customerId))}}"
        },
        //dom: "rtiS",
        "columns": [
            {"data":0},
