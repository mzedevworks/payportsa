...
Route::namespace('Merchant')->middleware('is_merchant','is_password_changed')->prefix('merchant')->group(function(){
	...
	Route::get('avs/history/realtime','AvsCustomerController@index')->middleware('is_product:avs','is_product:is_avs_rt');
	Route::get('avs/ajax-realtime-list', 'AvsCustomerController@ajaxRealtimeAvsList');
	Route::get('avs/history/batch','AvsCustomerController@batch')->middleware('is_product:avs','is_product:is_avs_batch');
	...
	Route::get('avs/history/batch/customer-list/{batchId}','AvsCustomerController@batchCustomerList')->middleware('is_product:avs','is_product:is_avs_batch');
	Route::get('avs/ajax-batch-customer-list/{batchId}', 'AvsCustomerController@ajaxAvsBatchCustomerList');
	
	Route::get('avs/create-realtime','AvsCustomerController@createAvs')->middleware('is_product:avs','is_product:is_avs_rt');
	Route::get('avs/create-batch','AvsCustomerController@tempList')->middleware('is_product:avs','is_product:is_avs_batch');
