...
----
CREATE TABLE `change_tracker` ( `change_of` ENUM('collection','payment') NOT NULL ,  `target_id` INT NOT NULL ,  `change_statement` INT NOT NULL ,  `created_at` DATETIME NOT NULL ) ENGINE = InnoDB;
ALTER TABLE `payments`  ADD `date_of_failure` DATETIME NULL  AFTER `tranx_error_id`;