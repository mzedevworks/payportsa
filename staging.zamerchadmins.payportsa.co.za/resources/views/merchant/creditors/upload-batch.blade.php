                ...
                <div class="card-body">
                    @if(!isset($selectedEmployees))
                       <form class="form-sample" method="post" 
                        action="{{ url('merchant/creditors/batchimport') }}" enctype="multipart/form-data" autocomplete="off">
                          @csrf
                       ...
                       <a href="{{ url('merchant/creditors/samplebatchcsv')}}" class="purple-btn">Download Sample csv</a>
                    @endif
                </div>
            </div>
        </div>
