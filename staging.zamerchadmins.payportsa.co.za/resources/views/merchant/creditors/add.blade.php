      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            action="{{ url('merchant/creditors/create') }}" autocomplete="off">
              @csrf
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('id_number')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Creditor Id" name="id_number" value="{{ old('id_number') }}">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{ $errors->first('salary')?'has-error':'' }}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Amount" name="salary" value="{{ old('salary') }}">
