        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{url('merchant/creditors/savecsvbatch')}}" class="btn bg-transparent" id="approveStatusForm">
                        {{csrf_field()}}
                        {{method_field('POST')}}
                        ...
                        <div id="batchContainerDiv">
                            <?php /* @foreach($selectedEmployees as $key => $employee)
                        ...
                        <a class="btn btn-common purple-btn mr-4" href="{{ url('merchant/creditors/create-batch')}}" class="purple-btn">Cancel</a>
                    </form>
