...
function generateAction(data, type, row, meta){
    ...
    var str='<div class="float-left"><a href="{{url('merchant/collection/reoccur/transmission/approval-list/')}}/'+data+'" class="btn btn-common mr-2">Collections</a></div>';
...
function formatBatchName(data, type, row, meta){
    ...
    var str='<a href="{{url('merchant/collection/reoccur/transmission/approval-list/')}}/'+data.id+'">'+data.batch_name+'</a>';
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
        ...
        ajax: {
            url: "{{ url('merchant/collection/reoccurbatch/ajax-approval-list')}}"
        },
        //dom: "rtiS",
        "columns": [
            {
