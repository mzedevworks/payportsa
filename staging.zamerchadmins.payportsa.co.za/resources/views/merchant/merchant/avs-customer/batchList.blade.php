...
function generateAction(data, type, row, meta){
    ...
    var str='<div class=""><a href="{{url('merchant/avs/history/batch/customer-list')}}/'+data+'" class="m-1 bg-transparent"><i class="lni-eye" aria-hidden="true"></i></a></div>';
    return str;
}
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
        ...
        searching: true,
        ajax: {
            url: "{{ url('merchant/avs/ajax-batch-list')}}"
        },
        //dom: "rtiS",
        "columns": [
            {
