          ...
          <div class="card-body">
            ...
            <div class="tab-info">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a href="{{url('merchant/employees/view/').'/'.Helper::encryptVar($empRes['id'])}}" class="nav-link">Employee Info</a>
                </li>
                <li class="nav-item">
                  <a href="{{url('merchant/employees/transactions/').'/'.Helper::encryptVar($empRes['id'])}}" class="nav-link active">History</a>
                </li>
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
        ...
        searching: true,
        ajax: {
            url: "{{ url('merchant/employees/transactions/ajax-tranx/'.Helper::encryptVar($employeeId))}}"
        },
        //dom: "rtiS",
        "columns": [
            {"data":0},
