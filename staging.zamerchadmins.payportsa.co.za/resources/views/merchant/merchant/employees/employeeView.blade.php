          ...
          <div class="card-body">
            ...
            <div class="tab-info">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a href="{{url('merchant/employees/view/').'/'.Helper::encryptVar($empRes['id'])}}" class="nav-link active">Employee Info</a>
                </li>
                <li class="nav-item">
                  <a href="{{url('merchant/employees/transactions/').'/'.Helper::encryptVar($empRes['id'])}}" class="nav-link">History</a>
                </li>
                ...
                <div role="tabpanel" class="tab-pane active" id="default-tab-1">
                  <div class="p-20">
                    ...
                    <div class="row">
                      ...
                      <a href="{{url('merchant/employees/update/').'/'.Helper::encryptVar($empRes['id'])}}" class="btn btn-common">Edit</a>
                  </div>
                </div>
