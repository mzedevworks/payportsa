        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <form method="POST" action="{{url('merchant/collection/normal/savebatch')}}" class="btn bg-transparent" id="approveStatusForm">
                        {{csrf_field()}}
                        {{method_field('POST')}}
...
function createReffrenceInput(data, type, row, meta){
    ...
    var str='<input data-id="'+row[0]+'" id="refference_'+row[0]+'" type="text" class="form-control" placeholder="reffrence" name="reffrence" value="'+data+'"  onchange="updateCustomer(this)">';
