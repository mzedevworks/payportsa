      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            action="{{ url('merchant/collection/normal/create-batch') }}">
              @csrf
              <div class="row">
                ...
                <div class="col-md-12" id="batchPaymentDateHolder" >
                  ...
                  <div class="form-group row {{$errors->first('collection_date')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="collection_batch_date" class="form-control" placeholder="Collection Date" name="collection_date" value="{{ old('collection_date') }}">
