    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-sample" method="post" action="{{ isset($employee->id) && $employee->id!='' ? url('merchant/collection/reoccur/customer/'.encrypt($employee->id)) : url('merchant/collection/reoccur/customer/create') }}">
              @csrf
