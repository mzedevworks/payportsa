          ...
          <div class="card-body">
            ...
            @endif 
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row {{$errors->first('subrub')?'has-error':''}}">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Subrub" name="suburb" value="{{old('subrub',$cusRes['subrub'])}}">
              ...
              @if($cusRes['status']!=2)
                ...
                <a href="{{ url('merchant/collection/reoccur/customer/pending-list') }}" class="btn btn-light">Cancel</a>
              </form>
              @endif
...
$(document).ready(function(){
  ...
  getCollectionDate('2 Day',false,'reoccur');
