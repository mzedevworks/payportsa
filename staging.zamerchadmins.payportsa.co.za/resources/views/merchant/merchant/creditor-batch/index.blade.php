...
function generateAction(data, type, row, meta){
    ...
    var str='<div class=""><a href="{{url('merchant/creditors/batch/pending-transaction/')}}/'+data+'" class="m-1 bg-transparent" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="lni-pencil" aria-hidden="true"></i></a>';
    str+='<a href="{{url('merchant/creditors/batch/pending-tranx-detail/')}}/'+data+'" class="m-1 bg-transparent"  data-toggle="tooltip" data-placement="top" data-original-title="View Detail"><i class="lni-eye" aria-hidden="true"></i></a>';
...
function formatBatchName(data, type, row, meta){
    ...
    var str='<a href="{{url('merchant/creditors/batch/pending-transaction/')}}/'+data.id+'">'+data.batch_name+'</a>';
    ...
    confirmDialog("Are you sure to "+actionType+" this record?", (ans) => {
        if (ans) {
            $.ajax({
                ...
                type  : 'post',
                url   : "{{url('merchant/creditors/batch/statusupdate')}}",
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
        ...
        ajax: {
            url: "{{ url('merchant/creditors/batch/ajax-pending')}}"
        },
        //dom: "rtiS",
        "columns": [
            {
