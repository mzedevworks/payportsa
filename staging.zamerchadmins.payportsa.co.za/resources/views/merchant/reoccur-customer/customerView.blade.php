          ...
          <div class="card-body">
            ...
            <div class="tab-info">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a href="{{url('merchant/collection/reoccur/customer/view/').'/'.Helper::encryptVar($cusRes['id'])}}" class="nav-link active">Customer Info</a>
                </li>
                <li class="nav-item">
                  <a href="{{url('merchant/collection/reoccur/customer/transactions/').'/'.Helper::encryptVar($cusRes['id'])}}" class="nav-link">History</a>
                </li>
                ...
                <div role="tabpanel" class="tab-pane active" id="default-tab-1">
                  <div class="p-20">
                    ...
                    <div class="row">  
                      ...
                      <a href="{{url('merchant/collection/reoccur/customer/update/').'/'.Helper::encryptVar($cusRes['id'])}}" class="btn btn-common">Edit</a>
