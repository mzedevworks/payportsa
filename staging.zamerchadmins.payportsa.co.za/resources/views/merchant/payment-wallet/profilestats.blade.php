  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-inline ml-2" method="post" action="{{url('merchant/wallet/payment') }}">
            @csrf
                    ...
                    <tr>
                      ...
                      <td>
                        @if($eachStatement['transaction_type']=='batch_payment')
                          <a target="_blank" href="{{ url('merchant/wallet/payment/tranx/'.encrypt($eachStatement['target_reffrence_id'])) }}">
