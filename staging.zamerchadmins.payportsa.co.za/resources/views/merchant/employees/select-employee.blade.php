...
function createReffrenceInput(data, type, row, meta){
    var str='<input data-id="'+row[0]+'" id="refference_'+row[0]+'" type="text" class="form-control" placeholder="refrence" name="reffrence" value="'+data+'"  onchange="updateEmployee(this)">';
