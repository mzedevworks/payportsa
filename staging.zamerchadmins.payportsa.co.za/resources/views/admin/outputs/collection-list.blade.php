...
$(document).ready(function() {
    myFirmTable=$('#firms-datatable').DataTable({
        ...
        searching: true,
        ajax: {
            url: "{{ url('admin/outputs/ajax-collection-listing')}}"
        },
        //dom: "rtiS",
        "columns": [
