                    ...
                    <label class="col-sm-3">AVS *</label>
                      ...
                      <div class="col-sm-9">
                        <div class="custom-control custom-radio radio custom-control-inline">
                          ...
                          <input type="radio" class="custom-control-input" id="is_avs_true" name="is_avs" value="1" {{ (intval(old('is_avs'))===1) ? 'checked': ''}}>
                          <label class="custom-control-label" for="is_avs_true">Yes</label>
                        </div>
                      
                        <div class="custom-control custom-radio radio custom-control-inline">
                          
                          <input type="radio" class="custom-control-input" id="is_avs_false" name="is_avs" value="0" {{ (intval(old('is_avs'))===0 && sizeof($errors)>0 && !$errors->first('is_avs')) ? 'checked': ''}}>
