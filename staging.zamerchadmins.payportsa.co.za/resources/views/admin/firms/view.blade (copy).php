                ...
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-header border-bottom">
                      <h4 class="card-title">Details view of Merchant {{$firm->business_name}}</h4>
                    </div>
                    <div class="tab-info">
                      
                      @include('admin.firms.view-detail-tabs')
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="merchantInfo">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group row {{ $errors->first('registration_no')?'has-error':'' }}">
                                  <label class="col-sm-3 col-form-label">Registartion No *</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="registration_no" class="form-control" placeholder="Registartion No." value="{{old('registration_no',$firm['registration_no']) }}">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group row {{ $errors->first('subrub')?'has-error':'' }}">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" name="subrub" class="form-control" placeholder="Subrub" value="{{old('subrub',$firm['subrub'])}}">
                                ...
                                <div class="form-group row {{ $errors->first('bank_id')?'has-error':'' }}">
                                  ...
                                  <div class="col-sm-9">
                                    <select class="form-control" name="bank_id" id="bank_id">
                                      ...
                                      >{{ $bankDetail->bank_name }}({{ $bankDetail->branch_code }})</option>
                                      @endforeach
                                    </select>
