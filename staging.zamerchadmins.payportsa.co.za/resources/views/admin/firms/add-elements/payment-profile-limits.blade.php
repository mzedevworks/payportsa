<div class="row">
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('line_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Line Limit" name="line_payment" value="{{ old('line_payment') }}">
  ...
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('batch_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Batch Limit" name="batch_payment" value="{{ old('batch_payment') }}">
  ...
  <!-- <div class="col-md-6">
    <div class="form-group row {{ $errors->first('daily_payment')?'has-error':'' }}">
      <label class="col-sm-3 col-form-label">Daily Limit</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Daily Limit" name="daily_payment" value="{{ old('daily_payment') }}">
        <p class="error">{{ $errors->first('daily_payment')}}</p>
      </div>
    </div>
  </div> -->
  ...
  <div class="col-md-6">
    <div class="form-group row {{ $errors->first('monthly_payment')?'has-error':'' }}">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Monthly Limit" name="monthly_payment" value="{{ old('monthly_payment') }}">
