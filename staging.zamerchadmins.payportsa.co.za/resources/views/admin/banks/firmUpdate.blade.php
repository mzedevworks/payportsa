                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-sample" method="post" autocomplete="off">
                        ...
                        <p class="card-description">Collection Once Off</p>
                        <div class="row">
                          <div class="col-md-6">
                              ...
                              <div class="col-sm-9">
                                <select class="form-control" name="service_type" id="service_type">
                                  ...
                                  @foreach(Config('constants.serviceType') as $key =>$service)
                                    <option value="{{$service}}" {{$service==old('service_type')?'selected':''}}>{{$service}}</option>
                                  @endforeach
                                </select>
                        ...
                        <p class="card-description">Collection Recurring</p>
                        <div class="row">  
                          ...
                          <div class="col-md-6" id="duration">
                            <div class="form-group row {{ $errors->first("duration")?"has-error":""}}">
                              <label class="col-sm-3 col-form-label">Duration(In months)**</label><div class="col-sm-9">
                              <input type="text" class="form-control recurringEntity" placeholder="Duration(In Months)" name="duration" value="{{ old('duration')}}"><p class="error">{{ $errors->first("duration")}}</p></div>
                              </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row {{$errors->first('service_type')?'has-error':''}}">
                              ...
                              <label class="col-sm-3">Payments *</label>
                                ...
                                <div class="col-sm-9">
                                  ...
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    ...
                                    <input type="radio" class="custom-control-input" id="is_payment_false" name="is_payment" value="0" {{ (intval(old('is_payment',$firm['is_payment']))===0 && sizeof($errors)>0 && !$errors->first('is_payment')) ? 'checked': ''}}  onclick="verifySubproductVisiblity()">
                              ...
                              <label class="col-sm-3">Collections *</label>
                                ...
                                <div class="col-sm-9">
                                  ...
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    ...
                                    <input type="radio" class="custom-control-input" id="is_collection_false" name="is_collection" value="0" {{ (intval(old('is_collection'))===0 && sizeof($errors)>0 && !$errors->first('is_collection',$firm['is_collection'])) ? 'checked': ''}} onclick="verifySubproductVisiblity()">
                              ...
                              <label class="col-sm-3">DebiCheck *</label>
                                ...
                                <div class="col-sm-9">
                                  ...
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    ...
                                    <input type="radio" class="custom-control-input" id="is_debicheck_false" name="is_debicheck" value="0" {{ (intval(old('is_debicheck',$firm['is_debicheck']))===0 && sizeof($errors)>0 && !$errors->first('is_debicheck')) ? 'checked': ''}}>
                              ...
                              <label class="col-sm-3">AVS *</label>
                                ...
                                <div class="col-sm-9">
                                  ...
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    ...
                                    <input type="radio" class="custom-control-input" id="is_avs_false" name="is_avs" value="0" {{ (intval(old('is_avs',$firm['is_avs']))===0 && sizeof($errors)>0 && !$errors->first('is_avs')) ? 'checked': ''}}>
