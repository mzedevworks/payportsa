                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row {{ $errors->first('holiday_event')?'has-error':'' }}">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Holiday Event" name="holiday_event" value="{{old('holiday_event',$publicHoliday['holiday_event'])}}">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row {{ $errors->first('holiday_date')?'has-error':'' }}">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Holiday Date" id="holiday_date" name="holiday_date" value="{{ Helper::convertDate(old('holiday_date',$publicHoliday['holiday_date']) ,'d-m-Y')}}">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3">Do it will Reccur *</label>
                            
                                <div class="col-sm-9">
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" name="is_reocurr" value="1" id="is_reocurr_true" {{ (intval(old('is_reocurr',$publicHoliday['is_reocurr']))===1) ? 'checked': ''}}>
                                    <label class="custom-control-label" for="is_reocurr_true">Yes</label>
                                  </div>
                                
                                  <div class="custom-control custom-radio radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="is_reocurr_false" name="is_reocurr" value="0" {{ (intval(old('is_reocurr',$publicHoliday['is_reocurr']))==0 ) ? 'checked': ''}} >
