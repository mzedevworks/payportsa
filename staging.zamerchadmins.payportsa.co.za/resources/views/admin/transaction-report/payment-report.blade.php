  ...
  <div class="row">
    <div class="col-12 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-sample" method="get" action="{{url('admin/tranx-report/payment') }}" autocomplete="off">
            @csrf
            <div class="row">
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" placeholder="Employee Id" id="employee_id" name="employee_id" value="{{old('employee_id',$request->employee_id)}}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <select class="form-control" name="serviceType" id="serviceType">
                      ...
                      <option value="dated" {{'dated'==old('serviceType',$request->serviceType)?'selected':''}}>Dated</option>
                      <option value="sameday" {{'sameday'==old('serviceType',$request->serviceType)?'selected':''}}>Sameday</option>
...
$(document).ready(function() {
    ...
    myCustomerTable=$('#customers-datatable').DataTable( {
      "lengthMenu": [ [25, 50, 100,200,500,1000, -1], [25, 50, 100,200,500,1000, "All"] ],
        ...
        ajax: {
            url: "{{ url('admin/tranx-report/payment/ajax-reports')}}",
            data: function ( d ) {
