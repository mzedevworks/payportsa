...
class CreditController extends Controller
{
    ...
    {     
        ...
        return view('merchant.credit.pending-list',compact('pagename','batchId'));
    }
    ...
    {     
        ...
        return view('merchant.credit.pending-list-view',compact('pagename','batchId'));
    }
    ...
    public function ajaxPendingList(Request $request){
        ...
        $paymentBatch=PaymentBatches::where(['firm_id'=>$firmId,'id'=>$batchId,'batch_type'=>'credit'])->first();
    ...
    {     
        ...
        if($batchCollections->batch->batch_status!='approved'){
            return redirect('merchant/creditors/batch/queued');
        }
        return view('merchant.credit.queued-list',compact('pagename','batchId'));
    }
    ...
    {     
        ...
        if($batchCollections->batch->batch_status!='processed'){
            return redirect('merchant/creditors/batch/processed');
        }
        return view('merchant.credit.processed-list',compact('pagename','batchId'));
    }
