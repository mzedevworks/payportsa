...
class CreateDatedPayCmd extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'transaction:create-oneday-payment-eft';
     ...
     * @var string
     */
    protected $description = 'Create and upload transmission files for One day Payments EFT (ONEDAYPAFF)';
    ...
    public function __construct()
    {
        ...
        $this->localDir=Config('constants.localOneDayPaymentFileStoragePath');
        $this->remoteDir=Config('constants.remoteOneDayPaymentOutputPath');
        $this->environment=Config('constants.payportEnv');
        $this->bankserUserCode = Config('constants.oneDayPaymentbankSerUserCode');
        $this->electronicBankingSuitUserCode = Config('constants.oneDayPaymentSuitUserCode');
        $this->electronicBankingSuitUserName = Config('constants.oneDayPaymentSuitUserName');
        ...
        //echo Helper::getNextCollectionDate("2020-02-01","Monthly",false);
        //echo Helper::getCollectionEndDate("2020-01-28","Monthly",3,false);
        //die();
    }
    ...
    public function handle()
    {
        ...
        $output .= $this->generateUserSet($this->paymentTransactions,"ONEDAY");
    ...
    function uploadTransmissionFile(){
        ...
        if($sftp){
           ...
           $file_name = Config('constants.oneDayPaymentSuitFolder').".".Date("Ymdhis").".txt"; //name of the generated file
            ...
            $newTransmissionRecord->transmission_type='oneday';
           ...
           //     $message->to('emailid')->subject("Cron job fro ABSA");
           // });
    ...
    */
    function createRefrenceString($payment){
        ...
        */
        ...
        $userAbbrivatedCode = $this->companyBankInfo->account_holder_name;
    ...
    private function contraRecords($total_amount,$action_date,$payment){
        ...
        */
        ...
        $accountHolderName = $this->companyBankInfo->account_holder_name;
        //There is ixed length of the name , so we might needto put fillers
    ...
    */
    private function getTransmissionNumber(){
        ...
        $transmission = PaymentTransmissionRecords::where('combined_status','ACCEPTED')->where('transmission_type','oneday')->orderBy('id','desc')->first();
    ...
    private function fetchPaymentRecords(){
        $this->paymentTransactions = $this->getRecords(['dated']); //sameday or dated
    ...
    */
    private function isTransmissionResultAwaited(){
        $lastTranmission=PaymentTransmissionRecords::where('transmission_type','oneday')->orderBy('id','desc')->first(); 
